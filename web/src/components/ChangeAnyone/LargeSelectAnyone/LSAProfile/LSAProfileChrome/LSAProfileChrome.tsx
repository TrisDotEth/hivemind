    ...
    <div>
      ...
      {chooseAnyoneOpen && (
        <div className="relative mt-1 min-h-[6rem] text-center">
          ...
          <button
            className="focus:ring-indigo-500 absolute left-0 right-0 bottom-10 m-auto mb-1 inline-flex w-fit items-center rounded-lg border border-transparent bg-primary px-4 py-1 text-xs font-medium text-white shadow-sm hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-offset-2"
